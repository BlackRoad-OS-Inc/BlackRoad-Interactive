...
**BlackRoad Interactive** is part of the **BlackRoad OS** ecosystem — a sovereign, distributed operating system built on edge computing, local AI, and mesh networking by **BlackRoad OS, Inc.**
...
> BlackRoad Interactive — gaming, metaverse, interactive experiences, simulations. Proprietary BlackRoad OS, Inc.
